...
def calculate_average(scores):
	...
	for score in scores:
		total += score
	return round(total / len(scores), 2) if scores else 0.0
...
def add_student(students):
	...
	for index in range(score_count):
		scores.append(int(input(f"Enter score {index + 1}: ")))
...
def display_students(students):
	...
	for student in students:
		...
		print(f"{student['name']:<14} {student['id']:<11} {scores_text:<14} {average:.2f}")
	print("--------------------------------------------------")
